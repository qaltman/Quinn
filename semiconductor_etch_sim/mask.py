...
class Mask:
    ...
    This OOP is used almost as a sketch where we are gooing to be using shapes and lines to represent different etches and photoresists that are common in legit semi conductor etching. 
    Internally the mask stores a 2D grid of true and false values where true represents the wafer being protected and false represents unprotected silicone
    """
